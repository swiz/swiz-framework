package org.swizframework.processors
{
	...
	{
		/**
		 * Built-in <code>ComponentProcessor</code> is the first native processor run to ensure
		 * items decorated with <code>[Component]</code> are made available for injection.
		 *
